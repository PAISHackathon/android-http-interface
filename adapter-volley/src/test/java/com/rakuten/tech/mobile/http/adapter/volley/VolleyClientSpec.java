...
import com.rakuten.tech.mobile.http.interop.HttpRequestSpec;
...
class VolleyClientSpec {
    ...
    public static class VolleyHttpRequestSpec extends HttpRequestSpec {
    ...
    public static class VolleyStatusCodeSpec extends StatusCodeSpec {
        ...
        public VolleyStatusCodeSpec(int statusCode) {
            super(statusCode);
        }
