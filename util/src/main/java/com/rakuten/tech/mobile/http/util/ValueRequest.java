...
public final class ValueRequest implements Http.Request {
  ...
  ValueRequest(byte[] body, Map<String, String> headers, String contentType, Uri url,
      String method) {
    this.body = body;
  ...
  public static class Builder {
    ...
    public Builder body(@NonNull byte[] body) {
      this.body = body;
      return this;
    }
    ...
    public ValueRequest build() {
      if (url == null || method == null) {
        throw new IllegalArgumentException("url and HTTP method may not be null");
      }
